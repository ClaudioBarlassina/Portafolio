export const texts = {
  en: {
    ...
    projects: {
      ...
      5: {
        liveTv: {
          title: 'LiveTV \u2013 World Cup 2026',
          label: 'Personal Project',
          description:
            'Multiplatform live streaming app for the 2026 World Cup, compatible with Android TV, Apple TV and Web. Multiple players (FULL, SPLIT, 1+2 and fullscreen), HLS streaming with built-in proxy to avoid CORS blocks, official 2026 World Cup real-time data (matches, standings, statistics), calendar with filters by group/team/status, standings table, elimination brackets, activation code subscription system with complete admin panel (code, channel and configuration management), responsive design, dark mode, keyboard/TV remote navigation and automatic updates every 30 seconds.',
          image: '01-main.png',
          techTitle: 'Technologies',
          tech: ['Expo', 'React Native', 'Node.js', 'MongoDB', 'HLS.js', 'Vercel', 'Render'],
          featuresTitle: 'Features',
          demo: 'https://like-tv.vercel.app/',
          github: 'https://github.com/ClaudioBarlassina/LiveTV',
          features: [
            'Multiplatform: Android TV, Apple TV and Web',
            'Multiple players: FULL, SPLIT, 1+2 and fullscreen',
            'HLS streaming with built-in CORS proxy',
            'Official 2026 World Cup real-time data (matches, standings, statistics)',
            'Calendar with filters by group/team/status',
            'Standings table and elimination brackets',
            'Activation code subscription system',
            'Complete admin panel (codes, channels, configuration)',
            'Responsive design and dark mode',
            'Keyboard and TV remote navigation',
  ...
  es: {
    ...
    projects: {
      ...
      5: {
        liveTv: {
          title: 'LiveTV \u2013 Mundial 2026',
          label: 'Proyecto Personal',
          description:
            'App de streaming en vivo multiplataforma para el Mundial 2026, compatible con Android TV, Apple TV y Web. Reproductores m\u00faltiples (FULL, SPLIT, 1+2 y pantalla completa), streaming HLS con proxy integrado anti-CORS, datos oficiales del Mundial 2026 en tiempo real (partidos, tablas, estad\u00edsticas), calendario con filtros por grupo/equipo/estado, tabla de posiciones, brackets de eliminatorias, sistema de suscripci\u00f3n por c\u00f3digo de activaci\u00f3n con panel admin completo (gesti\u00f3n de c\u00f3digos, canales y configuraci\u00f3n), dise\u00f1o responsive, modo oscuro, navegaci\u00f3n por teclado/control remoto TV y actualizaci\u00f3n autom\u00e1tica cada 30 segundos.',
          image: '01-main.png',
          techTitle: 'Tecnolog\u00edas',
          tech: ['Expo', 'React Native', 'Node.js', 'MongoDB', 'HLS.js', 'Vercel', 'Render'],
          featuresTitle: 'Funcionalidades',
          ...
          github: 'https://github.com/ClaudioBarlassina/LiveTV',
          features: [
            'Multiplataforma: Android TV, Apple TV y Web',
            'Reproductores m\u00faltiples: FULL, SPLIT, 1+2 y pantalla completa',
            'Streaming HLS con proxy anti-CORS',
            'Datos oficiales del Mundial 2026 en tiempo real (partidos, tablas, estad\u00edsticas)',
            'Calendario con filtros por grupo/equipo/estado',
            'Tabla de posiciones y brackets de eliminatorias',
            'Sistema de suscripci\u00f3n por c\u00f3digo de activaci\u00f3n',
            'Panel admin completo (c\u00f3digos, canales, configuraci\u00f3n)',
            'Dise\u00f1o responsive y modo oscuro',
            'Navegaci\u00f3n por teclado y control remoto TV',
